...
public class NavalArmamentsRebootedItems {
    ...
    public static final RegistryObject<Item> WOODEN_VAUL = ITEMS.register("wooden_vaul", ()-> new VaulItem(ItemTier.WOOD, NavalArmamentsRebootedConfig.COMMON.woodenVaulDamage.get()-1, -3.5f, new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 10, 1), new Item.Properties().rarity(Rarity.COMMON).durability(350).tab(ItemGroup.TAB_COMBAT)));
    ...
    public static final RegistryObject<Item> IRON_VAUL = ITEMS.register("iron_vaul", ()-> new VaulItem(ItemTier.IRON, NavalArmamentsRebootedConfig.COMMON.ironVaulDamage.get()-3, -3.4f, new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 10, 1), new Item.Properties().rarity(Rarity.COMMON).durability(890).tab(ItemGroup.TAB_COMBAT)));
    public static final RegistryObject<Item> GOLDEN_VAUL = ITEMS.register("golden_vaul", ()-> new VaulItem(ItemTier.GOLD, NavalArmamentsRebootedConfig.COMMON.goldenVaulDamage.get()-1, -3.4f, new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 10, 1), new Item.Properties().rarity(Rarity.COMMON).durability(890).tab(ItemGroup.TAB_COMBAT)));
